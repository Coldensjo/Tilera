...
#define __RME_VERSION_MINOR__ 13
...
// 16: server's editor version prepended to the CHANGE_CLIENT_VERSION payload;
//     servers accept mismatched editor versions (warning instead of kick).
#define __LIVE_NET_VERSION__ 16
